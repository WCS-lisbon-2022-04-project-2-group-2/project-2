...
function Attacks () {
    const {starterAttackName, starterAttackDamage, setStarterAttackDamage, wildHealth, setWildHealth, 
        setTextMessageOne, setTextMessageTwo, setWildFaint, setGameOver, starter, wildPokemon, setWildAttackDamage, 
        wildAttackName, setWildAttackName, starterHealth, setStarterHealth, setStarterFaint, wildAttackDamage} = useContext(GameContext)
